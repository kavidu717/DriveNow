    ...
    <div className="min-h-screen w-full flex flex-col bg-gray-50 relative pt-24">
      ...
      <div className="w-full mb-8">
        ...
        <div className="relative w-full h-80 sm:h-80 md:h-[400px] overflow-hidden shadow-md">
          ...
          {/* Banner Content */}
          <div className="relative z-10 h-full flex flex-col justify-center px-6 sm:px-12 md:px-20 max-w-4xl">
            <span className="text-orange-400 font-bold uppercase tracking-wider text-xs sm:text-sm mb-3">
              DriveNow Luxury Fleet
            </span>
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight leading-tight">
              Find Your Perfect Ride <br className="hidden sm:block"/> For Any Journey
            </h1>
            <p className="text-gray-300 text-sm md:text-base mt-4 max-w-lg hidden sm:block leading-relaxed">
              Choose from hundreds of premium vehicles inspected thoroughly to guarantee your absolute comfort and safety.
            </p>
          </div>
        </div>
      </div>
