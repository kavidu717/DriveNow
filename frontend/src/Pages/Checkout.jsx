...
export default function Checkout() {
  ...
  useEffect(() => {
    ...
    // Simulate a tiny network delay for a smooth loading transition
    setTimeout(() => {
          ...
          <div className="w-full lg:w-2/3 space-y-6">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="p-6 sm:p-8 border-b border-gray-100">
                ...
                <p className="text-gray-500 mt-1">Please confirm the details of your reservation.</p>
              </div>

              <div className="p-6 sm:p-8 flex flex-col sm:flex-row gap-6">
                <div className="w-full sm:w-1/3 h-48 bg-gray-100 rounded-xl overflow-hidden relative shadow-inner">
                  <img
                    src={booking.vehicleImage || "https://via.placeholder.com/600x400?text=Vehicle+Image"}
            ...
            {/* Trust / Policy Card */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 flex items-start gap-4">
              <div className="bg-blue-50 p-3 rounded-full text-blue-600">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
              </div>
              <div>
                <h4 className="text-lg font-bold text-gray-900">Free Cancellation</h4>
                <p className="text-gray-500 text-sm mt-1 leading-relaxed">
                  You can cancel this booking for free up to 24 hours before your pick-up date. No hidden fees.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-6 sm:p-8">
              ...
              <div className="space-y-4 mb-6 text-gray-600 border-b border-gray-100 pb-6">
                <div className="flex justify-between">
                  <span>Base Rate ({booking.pricePerKm} LKR/km)</span>
                  <span className="font-medium text-gray-900">LKR {(booking.pricePerKm * booking.estimatedKm).toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
              ...
              <div className="mt-6 flex items-center justify-center gap-2 text-xs text-gray-400 font-medium">
                ...
                256-bit SSL Encrypted • Ready for PayHere
              </div>
            </div>
          </div>
